...
public class calculator1 extends Activity implements B4AActivity{
	public static calculator1 mostCurrent;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.AutoScaleExample7", "b4a.AutoScaleExample7.calculator1");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (calculator1).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.AutoScaleExample7", "b4a.AutoScaleExample7.calculator1");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.AutoScaleExample7.calculator1", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (calculator1) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (calculator1) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (calculator1) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
mostCurrent._activity.LoadLayout("calc1_main",mostCurrent.activityBA);
 //BA.debugLineNum = 22;BA.debugLine="Activity.Title = \"Calculator1\"";
mostCurrent._activity.setTitle(BA.ObjectToCharSequence("Calculator1"));
 //BA.debugLineNum = 24;BA.debugLine="pnlCalculator.LoadLayout(\"calc1_calculator\")";
mostCurrent._pnlcalculator.LoadLayout("calc1_calculator",mostCurrent.activityBA);
 //BA.debugLineNum = 25;BA.debugLine="pnlFunctions.LoadLayout(\"calc1_functions\")";
mostCurrent._pnlfunctions.LoadLayout("calc1_functions",mostCurrent.activityBA);
...
if (mostCurrent._pnlcalculator.getHeight()>(anywheresoftware.b4a.keywords.Common.Min(mostCurrent._activity.getWidth(),mostCurrent._activity.getHeight())-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (50)))) { 
...
if (mostCurrent._activity.getWidth()>mostCurrent._pnlcalculator.getWidth()+mostCurrent._pnlfunctions.getWidth()) { 
