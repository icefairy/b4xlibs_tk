...
public class listview extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.AutoScaleExample7", "b4a.AutoScaleExample7.listview");
			...
			if (p != null && p != this) {
                BA.LogInfo("Killing previous instance (listview).");
				p.finish();
			}
		}
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.AutoScaleExample7", "b4a.AutoScaleExample7.listview");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.AutoScaleExample7.listview", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
			_activity.reinitializeForShell(activityBA, "activity");
		}
        initializeProcessGlobals();		
        initializeGlobals();
        
        BA.LogInfo("** Activity (listview) Create, isFirst = " + isFirst + " **");
        processBA.raiseEvent2(null, true, "activity_create", false, isFirst);
		isFirst = false;
		if (this != mostCurrent)
			return;
        processBA.setActivityPaused(false);
        BA.LogInfo("** Activity (listview) Resume **");
...
@Override
 ...
 protected void onStop() {
	...
	public void onPause() {
        ...
        BA.LogInfo("** Activity (listview) Pause, UserClosed = " + activityBA.activity.isFinishing() + " **");
...
public anywheresoftware.b4a.objects.PanelWrapper _pnllistview = null;
public anywheresoftware.b4a.objects.LabelWrapper _lbllistviewtitle = null;
public anywheresoftware.b4a.objects.ListViewWrapper _ltvtest = null;
...
mostCurrent._activity.LoadLayout("listview",mostCurrent.activityBA);
...
mostCurrent._pnllistview.setLeft((int) ((anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._pnllistview.getWidth())/(double)2));
 //BA.debugLineNum = 25;BA.debugLine="pnlListView.Height = 100%y";
mostCurrent._pnllistview.setHeight(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 26;BA.debugLine="ltvTest.Height = pnlListView.Height - ltvTest.Top";
mostCurrent._ltvtest.setHeight((int) (mostCurrent._pnllistview.getHeight()-mostCurrent._ltvtest.getTop()-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10))*mostCurrent._scale._getscaley(mostCurrent.activityBA)));
...
_bmp.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"rose.png");
...
mostCurrent._ltvtest.AddSingleLine(BA.ObjectToCharSequence("One line "+BA.NumberToString(_i)));
 //BA.debugLineNum = 45;BA.debugLine="ltvTest.AddTwoLines(\"First line \" & i, \"Second l";
mostCurrent._ltvtest.AddTwoLines(BA.ObjectToCharSequence("First line "+BA.NumberToString(_i)),BA.ObjectToCharSequence("Second line "+BA.NumberToString(_i)));
 //BA.debugLineNum = 46;BA.debugLine="ltvTest.AddTwoLinesAndBitmap(\"First line \" & i,";
mostCurrent._ltvtest.AddTwoLinesAndBitmap(BA.ObjectToCharSequence("First line "+BA.NumberToString(_i)),BA.ObjectToCharSequence("Second line "+BA.NumberToString(_i)),(android.graphics.Bitmap)(_bmp.getObject()));
 }
};
...
mostCurrent._pnllistview = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 14;BA.debugLine="Dim lblListViewTitle As Label";
mostCurrent._lbllistviewtitle = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 15;BA.debugLine="Dim ltvTest As ListView";
mostCurrent._ltvtest = new anywheresoftware.b4a.objects.ListViewWrapper();
