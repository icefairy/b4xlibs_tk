...
public class calculator_subs_5 {
...
calculator.mostCurrent._scale.runVoidMethod ("_setrate",calculator.mostCurrent.activityBA,(Object)(BA.numberCast(double.class, 0.4)));
 BA.debugLineNum = 47;BA.debugLine="Scale.ScaleAll(Activity, FirstTime)";
Debug.ShouldStop(16384);
calculator.mostCurrent._scale.runVoidMethod ("_scaleall",calculator.mostCurrent.activityBA,RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.PanelWrapper"), calculator.mostCurrent._activity.getObject()),(Object)(_firsttime));
