...
public class LunarDate {
	...
	/** 干支刻 **/
	private String cnEraKe;
	/** 干支分**/
	private String cnEraFen;
	/** 干支秒**/
	private String cnEraMiao;
	...
	public String getCnEraKe() {
		return cnEraKe;
	}
	public String getCnEraMiao() {
		return cnEraMiao;
	}

	public void setCnEraMiao(String cnEraMiao) {
		this.cnEraMiao = cnEraMiao;
	}
	public void setCnEraKe(String cnEraKe) {
		this.cnEraKe = cnEraKe;
	}

	public String getCnEraFen() {
		return cnEraFen;
	}

	public void setCnEraFen(String cnEraFen) {
		this.cnEraFen = cnEraFen;
	}
