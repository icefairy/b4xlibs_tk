...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 31;BA.debugLine="dispopt.Initialize";
mostCurrent._dispopt.Initialize(processBA);
 //BA.debugLineNum = 32;BA.debugLine="dispopt.cacheInMemory(False).cacheOnDisc(False).r";
mostCurrent._dispopt.cacheInMemory(anywheresoftware.b4a.keywords.Common.False).cacheOnDisc(anywheresoftware.b4a.keywords.Common.False).resetViewBeforeLoading(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 33;BA.debugLine="uil.Initialize(\"uil\",dispopt.build)";
...
public static String  _button1_click() throws Exception{
 ...
 //BA.debugLineNum = 71;BA.debugLine="showPicker(3)";
_showpicker((int) (3));
 //BA.debugLineNum = 72;BA.debugLine="End Sub";
return "";
}
public static String  _gf_onhanlderfailure(int _requestcode,String _errormsg) throws Exception{
 //BA.debugLineNum = 45;BA.debugLine="Sub gf_onHanlderFailure(requestCode As Int,errorMs";
 //BA.debugLineNum = 46;BA.debugLine="ToastMessageShow(\"SelectPicErr:\"&errorMsg,True)";
...
cn.finalteam.galleryfinal.model.PhotoInfo _tp = null;
 //BA.debugLineNum = 48;BA.debugLine="Sub gf_onHanlderSuccess(reqeustCode As Int,resultL";
 //BA.debugLineNum = 49;BA.debugLine="If resultList.Size>0 Then";
if (_resultlist.getSize()>0) { 
 //BA.debugLineNum = 50;BA.debugLine="For i=0 To resultList.Size-1";
{
final int step2 = 1;
final int limit2 = (int) (_resultlist.getSize()-1);
for (_i = (int) (0) ; (step2 > 0 && _i <= limit2) || (step2 < 0 && _i >= limit2); _i = ((int)(0 + _i + step2)) ) {
 //BA.debugLineNum = 51;BA.debugLine="Dim tp As PhotoInfo=resultList.Get(i)";
_tp = (cn.finalteam.galleryfinal.model.PhotoInfo)(_resultlist.Get(_i));
 //BA.debugLineNum = 52;BA.debugLine="TL(\"Selected:\"&tp.PhotoPath)";
...
public static String  _showpicker(int _num) throws Exception{
 //BA.debugLineNum = 37;BA.debugLine="Private Sub showPicker(num As Int)";
 //BA.debugLineNum = 38;BA.debugLine="gf.Init(\"gf\",gf.GREEN)";
mostCurrent._gf.Init(processBA,"gf",mostCurrent._gf.GREEN);
 //BA.debugLineNum = 39;BA.debugLine="If num>1 Then";
if (_num>1) { 
 //BA.debugLineNum = 40;BA.debugLine="gf.openGalleryMuti(1,num)";
mostCurrent._gf.openGalleryMuti((int) (1),_num);
 }else {
 //BA.debugLineNum = 42;BA.debugLine="gf.openGallerySingle(1)";
...
public static String  _tl(String _msg) throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Private Sub TL(msg As String)";
 //BA.debugLineNum = 58;BA.debugLine="Log(msg)";
anywheresoftware.b4a.keywords.Common.Log(_msg);
 //BA.debugLineNum = 59;BA.debugLine="ToastMessageShow(msg,False)";
