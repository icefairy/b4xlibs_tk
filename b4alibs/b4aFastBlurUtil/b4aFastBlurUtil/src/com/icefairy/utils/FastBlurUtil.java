 ...
 */
@BA.ShortName("FastBlurUtil")
@BA.Author("Icefairy333")
@BA.Version(1.00f)
@BA.Permissions(values = {"android.permission.INTERNET"})
public class FastBlurUtil {
    /*
     * A.net file: url="http://blog.foreverlove.us/girl2.png" ;
     * B.localfile:url="file://mnt/sdcard/photo/image.png";
     * C.support ,png, jpg,bmp,gif and so on
     * @param url
     * @return
     */
