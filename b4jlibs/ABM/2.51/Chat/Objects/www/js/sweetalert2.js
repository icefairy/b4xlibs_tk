    ...
    if (hasClass(elem.childNodes[i], className)) {
      return elem.childNodes[i];
		...
		if (elem.childNodes[i].childNodes.length>0) {
			if (hasClass(elem.childNodes[i].childNodes[0], className)) {
				return elem.childNodes[i].childNodes[0];
			}
		}
	}
  }
...
var setParameters = function setParameters(params) {
  ...
  closeButton.style.color = params.closeButtonColor;
  title.style.color = params.titleColor;
  content.style.color = params.contentColor;
  ...
  if (params.buttonsStyling) {
	...
	confirmButton.style.color = params.confirmButtonTextColor;
    cancelButton.style.color = params.cancelButtonTextColor;
  }
    ...
    (function () {
      switch (params.input) {
        ...
        case 'tel':
		  ...
		  $('#swal2text').attr('class', params.inputTextClass);
          show(input);
          break;
        case 'file':
        ...
        case 'radio':
          ...
          populateInputOptions = function populateInputOptions(inputOptions) {
            for (var radioValue in inputOptions) {
			  ...
			  radioLabelSpan.style.color = params.radioTextColor;
        ...
        case 'checkbox':
		  ...
		  label.style.color = params.checkboxTextColor;
        ...
        case 'textarea':
		  ...
		  textarea.style.color = params.textareaTextColor;
          show(textarea);
          break;
        case null:
          break;
