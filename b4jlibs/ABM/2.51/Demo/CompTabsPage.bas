...
Sub ConnectPage()
	...
	tabs.AddTab("tab1", "Demo TAB 1 Text", BuildTabContainer("tab1", "Demo tab text TAB1"),3,3,3,12,12,12,True,False, "", "") 
	tabs.AddTab("tab2", "Demo TAB 2 Text", BuildTabContainer("tab2", "Demo tab text TAB2"),3,3,3,12,12,12,True,True, "mdi-action-account-circle", "") 
	tabs.AddTab("tab3", "Demo TAB 3 Text", BuildTabContainer("tab3", "Demo tab text TAB3"),3,3,3,12,12,12,False,False, "", "") 
	...
	tabs.AddTab("tab4", "Demo TAB 4 Text", tbl1cont,3,3,3,12,12,12,True,False, "","") 
