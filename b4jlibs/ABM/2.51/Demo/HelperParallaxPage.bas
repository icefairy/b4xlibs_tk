...
Sub Class_Globals
	...
	Public Name As String = "HelperParallaxPage"
...
public Sub BuildPage()
	...
	page.PageTitle = "ABMParallax"
	page.PageDescription = "The parallax helper"	
	page.PageHTMLName = "abmaterial-parallax.html"
	page.PageKeywords = "ABMaterial, material design, B4X, B4J, SEO, framework, search engine optimization"
	page.PageSiteMapPriority = "0.50"
	page.PageSiteMapFrequency = ABM.SITEMAP_FREQ_MONTHLY
	page.UseGoogleAnalytics(ABMShared.TrackingID, Null) ' IMPORTANT Change this to your own TrackingID !!!!!!!
	
	ABMShared.BuildNavigationBar(page, "ABMParallax","../images/logo.png", "", "Helpers", "ABMParallax")
...
Sub ConnectPage()
	...
	' add paragraph	
	page.Cell(2,1).AddComponent(ABMShared.BuildParagraph(page,"par1","Parallax is an effect where the background content or image in this case, is moved at a different speed than the foreground content while scrolling. Adding it is as easy as using this code in B4J.") )
	...
	code.Append("page.Cell(1,1).AddComponent(parallax1)").Append(CRLF)
	...
	code.Append("page.Cell(4,1).AddComponent(parallax2)").Append(CRLF)
