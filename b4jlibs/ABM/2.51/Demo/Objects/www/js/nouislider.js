...
/*	Every input option is tested and parsed. This'll prevent
	...
	function addHandle ( direction, index, theme ) {
	...
	function addHandles ( nrHandles, direction, base, theme ) {
		...
		for ( index = 0; index < nrHandles; index += 1 ) {
			...
			handles.push( base.appendChild(addHandle( direction, index, theme )) );
		}
	...
	function addSlider ( direction, orientation, target, theme ) {

		// Apply classes and data to the target.
		addClass(target, theme);
...
function closure ( target, options ){
	...
	scope_Base = addSlider( options.dir, options.ort, scope_Target, options.theme );
	scope_Handles = addHandles( options.handles, options.dir, scope_Base, options.theme );
	...
	function initialize ( target, originalOptions ) {
		...
		if (originalOptions.tooltips === true || originalOptions.tooltips === undefined) {
			...
			tooltips[i].className += ' ' + options.theme + ' ';
