...
public class compsocialsharepage extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    public static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("abmaterial.ab.com", "abmaterial.ab.com.compsocialsharepage", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", abmaterial.ab.com.compsocialsharepage.class).invoke(this, new Object[] {null});
        else
...
com.ab.abmaterial.ABMLabel _lbl = null;
 //BA.debugLineNum = 170;BA.debugLine="Sub btn1_Clicked(Target As String)";
 //BA.debugLineNum = 171;BA.debugLine="Dim editor As ABMEditor = page.Component(\"editor\"";
_editor = (com.ab.abmaterial.ABMEditor)(_page.Component("editor"));
 //BA.debugLineNum = 172;BA.debugLine="Dim lbl As ABMLabel = page.Component(\"lbl\")";
_lbl = (com.ab.abmaterial.ABMLabel)(_page.Component("lbl"));
 //BA.debugLineNum = 173;BA.debugLine="lbl.Text = editor.GetHTML";
_lbl.Text = _editor.GetHTML();
 //BA.debugLineNum = 174;BA.debugLine="lbl.Refresh";
_lbl.Refresh();
...
_page.setShowLoaderType(_abm.LOADER_TYPE_MANUAL);
 //BA.debugLineNum = 106;BA.debugLine="page.PageTitle = \"ABMSocialShare\"";
_page.PageTitle = "ABMSocialShare";
 //BA.debugLineNum = 107;BA.debugLine="page.PageDescription = \"The social share componen";
_page.PageDescription = "The social share component ";
 //BA.debugLineNum = 108;BA.debugLine="page.PageHTMLName = \"abmaterial-social-share.html";
_page.PageHTMLName = "abmaterial-social-share.html";
...
_page.UseGoogleAnalytics(_abmshared._trackingid,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(__c.Null)));
 //BA.debugLineNum = 114;BA.debugLine="ABMShared.BuildNavigationBar(page, \"ABMSocialShar";
_abmshared._buildnavigationbar(_page,"ABMSocialShare","../images/logo.png","","Controls","ABMSocialShare");
 //BA.debugLineNum = 117;BA.debugLine="page.AddRows(8,True, \"\").AddCells12(1,\"\")";
...
_abm = new com.ab.abmaterial.ABMaterial();
 //BA.debugLineNum = 11;BA.debugLine="Public Name As String = \"CompSocialSharePage\"";
_name = "CompSocialSharePage";
...
com.ab.abmaterial.ABMSocialShare _socshare = null;
String _code1 = "";
...
_page.CellR((int) (0),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildparagraph(_page,"par1","ABMSocialShare is component for Social Network Sharing. It is based on jsSocials.")));
 //BA.debugLineNum = 134;BA.debugLine="Dim socshare As ABMSocialShare";
_socshare = new com.ab.abmaterial.ABMSocialShare();
 //BA.debugLineNum = 135;BA.debugLine="socshare.Initialize(page, \"socshare\", \"http://alw";
_socshare.Initialize(_page,"socshare","http://alwaysbusycorner.com/abmaterial/",(com.ab.abmaterial.ABMComponent)(__c.Null),"ABMaterial is fantastic!",_abm.SOCIALSHAREBUTTONTYPE_BUTTONLABELCOUNT);
 //BA.debugLineNum = 136;BA.debugLine="socshare.AddEmail";
_socshare.AddEmail();
 //BA.debugLineNum = 137;BA.debugLine="socshare.AddFacebook";
_socshare.AddFacebook();
 //BA.debugLineNum = 138;BA.debugLine="socshare.AddGooglePlus";
_socshare.AddGooglePlus();
 //BA.debugLineNum = 139;BA.debugLine="socshare.AddLinkedIn";
_socshare.AddLinkedIn();
 //BA.debugLineNum = 140;BA.debugLine="socshare.AddPintrest(\"https://www.youtube.com/wat";
_socshare.AddPintrest("https://www.youtube.com/watch?v=aGjFeBTb4Sc");
 //BA.debugLineNum = 141;BA.debugLine="socshare.AddTwitter(\"RealAlwaysBusy\", \"ABMaterial";
_socshare.AddTwitter("RealAlwaysBusy","ABMaterial,B4X");
 //BA.debugLineNum = 142;BA.debugLine="socshare.AddWhatsApp";
_socshare.AddWhatsApp();
 //BA.debugLineNum = 143;BA.debugLine="page.CellR(1,1).AddComponent(socshare)";
_page.CellR((int) (1),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_socshare));
 //BA.debugLineNum = 146;BA.debugLine="Dim code1 As String = $\"Dim socshare As ABMSocial";
_code1 = ("Dim socshare As ABMSocialShare\n"+"socshare.Initialize(page, \"socshare\", \"http://alwaysbusycorner.com/abmaterial/\", \"ABMaterial is fantastic!\", ABM.SOCIALSHAREBUTTONTYPE_BUTTONLABELCOUNT)\n"+"socshare.AddEmail\n"+"socshare.AddFacebook\n"+"socshare.AddGooglePlus\n"+"socshare.AddLinkedIn\n"+"socshare.AddPintrest(\"https://www.youtube.com/watch?v=aGjFeBTb4Sc\")\n"+"socshare.AddTwitter(\"RealAlwaysBusy\", \"ABMaterial,B4X\")\n"+"socshare.AddWhatsApp\n"+"page.CellR(1,1).AddComponent(socshare)");
 //BA.debugLineNum = 157;BA.debugLine="page.CellR(1,1).AddComponent(ABMShared.BuildCodeB";
_page.CellR((int) (1),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildcodeblockfromsmartstring(_page,"code1",_code1)));
 //BA.debugLineNum = 160;BA.debugLine="ABMShared.ConnectFooter(page)";
_abmshared._connectfooter(_page);
 //BA.debugLineNum = 162;BA.debugLine="page.Refresh ' IMPORTANT";
_page.Refresh();
 //BA.debugLineNum = 165;BA.debugLine="page.FinishedLoading 'IMPORTANT";
_page.FinishedLoading();
 //BA.debugLineNum = 167;BA.debugLine="page.RestoreNavigationBarPosition";
...
public String  _page_navigationbarclicked(String _action,String _value) throws Exception{
 //BA.debugLineNum = 178;BA.debugLine="Sub Page_NavigationbarClicked(Action As String, Va";
 //BA.debugLineNum = 179;BA.debugLine="page.SaveNavigationBarPosition";
_page.SaveNavigationBarPosition();
 //BA.debugLineNum = 180;BA.debugLine="If Action = \"ABMSocialShare\" Then Return";
if ((_action).equals("ABMSocialShare")) { 
if (true) return "";};
 //BA.debugLineNum = 181;BA.debugLine="If Action = \"Contact\" Then";
if ((_action).equals("Contact")) { 
 //BA.debugLineNum = 182;BA.debugLine="myToastId = myToastId + 1";
_mytoastid = (int) (_mytoastid+1);
 //BA.debugLineNum = 183;BA.debugLine="page.ShowToast(\"toast\" & myToastId, \"toastred\",";
...
if (true) return "";
 ...
 //BA.debugLineNum = 186;BA.debugLine="If Action = \"LogOff\" Then";
if ((_action).equals("LogOff")) { 
 //BA.debugLineNum = 187;BA.debugLine="ABMShared.LogOff(page)";
_abmshared._logoff(_page);
 //BA.debugLineNum = 188;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 190;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, Value)";
...
public String  _page_signedoffsocialnetwork(String _network,String _extra) throws Exception{
 //BA.debugLineNum = 193;BA.debugLine="Sub Page_SignedOffSocialNetwork(Network As String,";
 //BA.debugLineNum = 194;BA.debugLine="page.ws.Session.SetAttribute(\"authType\", \"\")";
_page.ws.getSession().SetAttribute("authType",(Object)(""));
 //BA.debugLineNum = 195;BA.debugLine="page.ws.Session.SetAttribute(\"authName\", \"\")";
_page.ws.getSession().SetAttribute("authName",(Object)(""));
 //BA.debugLineNum = 196;BA.debugLine="page.ws.Session.SetAttribute(\"IsAuthorized\", \"\")";
_page.ws.getSession().SetAttribute("IsAuthorized",(Object)(""));
 //BA.debugLineNum = 197;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, \"../\")";
