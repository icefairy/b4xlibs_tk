...
public class compsliderpage extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    public static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("abmaterial.ab.com", "abmaterial.ab.com.compsliderpage", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", abmaterial.ab.com.compsliderpage.class).invoke(this, new Object[] {null});
        else
...
com.ab.abmaterial.ABMImageSlider _slider = null;
 //BA.debugLineNum = 184;BA.debugLine="Sub btn1_Clicked(Target As String)";
 //BA.debugLineNum = 185;BA.debugLine="Dim slider As ABMImageSlider = page.Component(\"sl";
_slider = (com.ab.abmaterial.ABMImageSlider)(_page.Component("slider"));
 //BA.debugLineNum = 186;BA.debugLine="slider.Clear";
_slider.Clear();
 //BA.debugLineNum = 187;BA.debugLine="slider.AddSlideImage(\"../images/slider5.jpg\",\"Thi";
_slider.AddSlideImage("../images/slider5.jpg","This is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_LEFT);
 //BA.debugLineNum = 188;BA.debugLine="slider.AddSlideImage(\"../images/slider6.jpg\",\"Thi";
_slider.AddSlideImage("../images/slider6.jpg","This is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_CENTER);
 //BA.debugLineNum = 189;BA.debugLine="slider.AddSlideImage(\"../images/slider7.jpg\",\"Thi";
_slider.AddSlideImage("../images/slider7.jpg","This Is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_RIGHT);
 //BA.debugLineNum = 190;BA.debugLine="slider.AddSlideImage(\"../images/slider8.jpg\",\"Thi";
_slider.AddSlideImage("../images/slider8.jpg","This is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_CENTER);
 //BA.debugLineNum = 191;BA.debugLine="slider.AddSlideImage(\"../images/slider9.jpg\",\"Thi";
_slider.AddSlideImage("../images/slider9.jpg","This is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_LEFT);
 //BA.debugLineNum = 192;BA.debugLine="slider.AddSlideImage(\"../images/slider10.jpg\",\"Th";
_slider.AddSlideImage("../images/slider10.jpg","This is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_CENTER);
 //BA.debugLineNum = 193;BA.debugLine="slider.Refresh";
_slider.Refresh();
...
_page.setShowLoaderType(_abm.LOADER_TYPE_MANUAL);
 //BA.debugLineNum = 110;BA.debugLine="page.PageTitle = \"ABMImageSlider\"";
_page.PageTitle = "ABMImageSlider";
 //BA.debugLineNum = 111;BA.debugLine="page.PageDescription = \"The image slider/carousel";
_page.PageDescription = "The image slider/carousel component ";
 //BA.debugLineNum = 112;BA.debugLine="page.PageHTMLName = \"abmaterial-image-slider-caro";
_page.PageHTMLName = "abmaterial-image-slider-carousel.html";
...
_page.UseGoogleAnalytics(_abmshared._trackingid,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(__c.Null)));
 //BA.debugLineNum = 118;BA.debugLine="ABMShared.BuildNavigationBar(page, \"ABMImageSlide";
_abmshared._buildnavigationbar(_page,"ABMImageSlider","../images/logo.png","","Controls","ABMImageSlider");
 //BA.debugLineNum = 121;BA.debugLine="page.AddRows(1,True, \"\").AddCells12(1,\"\")";
_page.AddRows((int) (1),__c.True,"").AddCells12((int) (1),"");
 //BA.debugLineNum = 122;BA.debugLine="page.AddRows(1,True, \"\").AddCellsOS(1,0,2,2,12,8,";
_page.AddRows((int) (1),__c.True,"").AddCellsOS((int) (1),(int) (0),(int) (2),(int) (2),(int) (12),(int) (8),(int) (8),"");
 //BA.debugLineNum = 123;BA.debugLine="page.AddRows(4,True, \"\").AddCells12(1,\"\")";
...
_theme.Button("bluegrey").BackColorIntensity = _abm.INTENSITY_DARKEN1;
 //BA.debugLineNum = 98;BA.debugLine="theme.AddImageSliderTheme(\"slider300\")";
_theme.AddImageSliderTheme("slider300");
 //BA.debugLineNum = 99;BA.debugLine="theme.ImageSlider(\"slider300\").Height = 300";
_theme.ImageSlider("slider300").Height = (int) (300);
...
_abm = new com.ab.abmaterial.ABMaterial();
 //BA.debugLineNum = 11;BA.debugLine="Public Name As String = \"CompSliderPage\"";
_name = "CompSliderPage";
...
_page.Cell((int) (1),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildparagraph(_page,"par1","the image slider is a simple and elegant image carousel. You can also have captions that will be transitioned on their own depending on their alignment. You can also have indicators that show up on the bottom of the slider.")));
 //BA.debugLineNum = 140;BA.debugLine="Dim slider As ABMImageSlider";
_slider = new com.ab.abmaterial.ABMImageSlider();
 //BA.debugLineNum = 141;BA.debugLine="slider.Initialize(page, \"slider\", \"slider300\")";
_slider.Initialize(_page,"slider","slider300");
 //BA.debugLineNum = 144;BA.debugLine="slider.AddSlideImage(\"../images/slider1.jpg\",\"Thi";
_slider.AddSlideImage("../images/slider1.jpg","This is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_LEFT);
 //BA.debugLineNum = 145;BA.debugLine="slider.AddSlideImage(\"../images/slider2.jpg\",\"Thi";
_slider.AddSlideImage("../images/slider2.jpg","This is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_CENTER);
 //BA.debugLineNum = 146;BA.debugLine="slider.AddSlideImage(\"../images/slider3.jpg\",\"Thi";
_slider.AddSlideImage("../images/slider3.jpg","This Is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_RIGHT);
 //BA.debugLineNum = 147;BA.debugLine="slider.AddSlideImage(\"../images/slider4.jpg\",\"Thi";
_slider.AddSlideImage("../images/slider4.jpg","This is our big Title!","Here's a small slogan.",_abm.IMAGESLIDER_CENTER);
 //BA.debugLineNum = 149;BA.debugLine="page.Cell(2,1).AddComponent(slider)";
_page.Cell((int) (2),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_slider));
 //BA.debugLineNum = 152;BA.debugLine="Dim code As StringBuilder";
_code = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 153;BA.debugLine="code.Initialize";
_code.Initialize();
 //BA.debugLineNum = 154;BA.debugLine="code.Append(\"// create slider\").Append(CRLF)";
_code.Append("// create slider").Append(__c.CRLF);
 //BA.debugLineNum = 155;BA.debugLine="code.Append(\"Dim slider As ABMImageSlider\").Appen";
_code.Append("Dim slider As ABMImageSlider").Append(__c.CRLF);
 //BA.debugLineNum = 156;BA.debugLine="code.Append(\"slider.Initialize(page, \"\"slider\"\",";
_code.Append("slider.Initialize(page, \"slider\", \"\")").Append(__c.CRLF);
 //BA.debugLineNum = 157;BA.debugLine="code.Append(\"\").Append(CRLF)";
_code.Append("").Append(__c.CRLF);
 //BA.debugLineNum = 158;BA.debugLine="code.Append(\"// add images\").Append(CRLF)";
_code.Append("// add images").Append(__c.CRLF);
 //BA.debugLineNum = 159;BA.debugLine="code.Append(\"slider.AddSlideImage(\"\"../images/sli";
_code.Append("slider.AddSlideImage(\"../images/slider1.jpg\",\"This Is our big Title!\", \"Here's a small slogan.\", ABM.IMAGESLIDER_LEFT)").Append(__c.CRLF);
 //BA.debugLineNum = 160;BA.debugLine="code.Append(\"slider.AddSlideImage(\"\"../images/sli";
_code.Append("slider.AddSlideImage(\"../images/slider2.jpg\",\"This Is our big Title!\", \"Here's a small slogan.\", ABM.IMAGESLIDER_CENTER)").Append(__c.CRLF);
 //BA.debugLineNum = 161;BA.debugLine="code.Append(\"slider.AddSlideImage(\"\"../images/sli";
_code.Append("slider.AddSlideImage(\"../images/slider3.jpg\",\"This Is our big Title!\", \"Here's a small slogan.\", ABM.IMAGESLIDER_RIGHT)").Append(__c.CRLF);
 //BA.debugLineNum = 162;BA.debugLine="code.Append(\"slider.AddSlideImage(\"\"../images/sli";
_code.Append("slider.AddSlideImage(\"../images/slider4.jpg\",\"This Is our big Title!\", \"Here's a small slogan.\", ABM.IMAGESLIDER_CENTER)").Append(__c.CRLF);
 //BA.debugLineNum = 163;BA.debugLine="code.Append(\"\").Append(CRLF)";
_code.Append("").Append(__c.CRLF);
 //BA.debugLineNum = 164;BA.debugLine="code.Append(\"page.Cell(2,1).AddComponent(slider)\"";
_code.Append("page.Cell(2,1).AddComponent(slider)").Append(__c.CRLF);
 //BA.debugLineNum = 166;BA.debugLine="page.Cell(3,1).AddComponent(ABMShared.BuildCodeBl";
_page.Cell((int) (3),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildcodeblock(_page,"code",_code)));
 //BA.debugLineNum = 169;BA.debugLine="Dim btn1 As ABMButton";
_btn1 = new com.ab.abmaterial.ABMButton();
 //BA.debugLineNum = 170;BA.debugLine="btn1.InitializeRaised(page, \"btn1\", \"\", \"\", \"Load";
_btn1.InitializeRaised(_page,"btn1","","","Load other images","bluegrey");
 //BA.debugLineNum = 171;BA.debugLine="page.Cell(4,1).AddComponent(btn1)";
...
public String  _page_navigationbarclicked(String _action,String _value) throws Exception{
 //BA.debugLineNum = 197;BA.debugLine="Sub Page_NavigationbarClicked(Action As String, Va";
 //BA.debugLineNum = 198;BA.debugLine="page.SaveNavigationBarPosition";
_page.SaveNavigationBarPosition();
 //BA.debugLineNum = 199;BA.debugLine="If Action = \"GettingStarted\" Then Return";
if ((_action).equals("GettingStarted")) { 
if (true) return "";};
 //BA.debugLineNum = 200;BA.debugLine="If Action = \"Contact\" Then";
if ((_action).equals("Contact")) { 
 //BA.debugLineNum = 201;BA.debugLine="myToastId = myToastId + 1";
_mytoastid = (int) (_mytoastid+1);
 //BA.debugLineNum = 202;BA.debugLine="page.ShowToast(\"toast\" & myToastId, \"toastred\",";
...
if (true) return "";
 ...
 //BA.debugLineNum = 205;BA.debugLine="If Action = \"LogOff\" Then";
if ((_action).equals("LogOff")) { 
 //BA.debugLineNum = 206;BA.debugLine="ABMShared.LogOff(page)";
_abmshared._logoff(_page);
 //BA.debugLineNum = 207;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 209;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, Value)";
...
public String  _page_signedoffsocialnetwork(String _network,String _extra) throws Exception{
 //BA.debugLineNum = 212;BA.debugLine="Sub Page_SignedOffSocialNetwork(Network As String,";
 //BA.debugLineNum = 213;BA.debugLine="page.ws.Session.SetAttribute(\"authType\", \"\")";
_page.ws.getSession().SetAttribute("authType",(Object)(""));
 //BA.debugLineNum = 214;BA.debugLine="page.ws.Session.SetAttribute(\"authName\", \"\")";
_page.ws.getSession().SetAttribute("authName",(Object)(""));
 //BA.debugLineNum = 215;BA.debugLine="page.ws.Session.SetAttribute(\"IsAuthorized\", \"\")";
_page.ws.getSession().SetAttribute("IsAuthorized",(Object)(""));
 //BA.debugLineNum = 216;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, \"../\")";
