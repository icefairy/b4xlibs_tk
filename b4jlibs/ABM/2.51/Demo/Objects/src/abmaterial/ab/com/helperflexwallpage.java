...
public class helperflexwallpage extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    public static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("abmaterial.ab.com", "abmaterial.ab.com.helperflexwallpage", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", abmaterial.ab.com.helperflexwallpage.class).invoke(this, new Object[] {null});
        else
...
_page.setShowLoaderType(_abm.LOADER_TYPE_MANUAL);
 //BA.debugLineNum = 103;BA.debugLine="page.PageTitle = \"ABMFlexWall\"";
_page.PageTitle = "ABMFlexWall";
 //BA.debugLineNum = 104;BA.debugLine="page.PageDescription = \"The flex wall helper\"";
_page.PageDescription = "The flex wall helper";
 //BA.debugLineNum = 105;BA.debugLine="page.PageHTMLName = \"abmaterial-flexwall.html\"";
_page.PageHTMLName = "abmaterial-flexwall.html";
...
_page.UseGoogleAnalytics(_abmshared._trackingid,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(__c.Null)));
 //BA.debugLineNum = 111;BA.debugLine="ABMShared.BuildNavigationBar(page, \"ABMFlexWall\",";
_abmshared._buildnavigationbar(_page,"ABMFlexWall","../images/logo.png","","Helpers","ABMFlexWall");
...
_abm = new com.ab.abmaterial.ABMaterial();
 //BA.debugLineNum = 11;BA.debugLine="Public Name As String = \"HelperFlexWallPage\"";
_name = "HelperFlexWallPage";
...
com.ab.abmaterial.ABMFlexWall _flexwall = null;
int _i = 0;
...
_abmshared._connectnavigationbar(_page);
 //BA.debugLineNum = 128;BA.debugLine="page.Cell(1,1).AddComponent(ABMShared.BuildParagr";
_page.Cell((int) (1),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildparagraph(_page,"par1","The ABMFlexWall component is a quick helper to build a responsive image wall.")));
 //BA.debugLineNum = 130;BA.debugLine="Dim flexWall As ABMFlexWall";
_flexwall = new com.ab.abmaterial.ABMFlexWall();
 //BA.debugLineNum = 131;BA.debugLine="flexWall.Initialize(page, \"flexwall\", 350)";
_flexwall.Initialize(_page,"flexwall",(int) (350));
 //BA.debugLineNum = 133;BA.debugLine="For i = 1 To 20";
{
final int step5 = 1;
...
_flexwall.AddImage(_abmshared._buildimage(_page,"img"+BA.NumberToString(_i),"../images2/"+BA.NumberToString(_i)+".jpg",1,BA.NumberToString(_i)+".jpg"),(int) (1024),(int) (768));
 ...
 //BA.debugLineNum = 137;BA.debugLine="page.Cell(2,1).AddComponent(flexWall)";
_page.Cell((int) (2),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_flexwall));
 //BA.debugLineNum = 140;BA.debugLine="ABMShared.ConnectFooter(page)";
_abmshared._connectfooter(_page);
 //BA.debugLineNum = 142;BA.debugLine="page.Refresh ' IMPORTANT";
_page.Refresh();
 //BA.debugLineNum = 145;BA.debugLine="page.FinishedLoading 'IMPORTANT";
_page.FinishedLoading();
 //BA.debugLineNum = 147;BA.debugLine="page.RestoreNavigationBarPosition";
...
public String  _page_navigationbarclicked(String _action,String _value) throws Exception{
 //BA.debugLineNum = 151;BA.debugLine="Sub Page_NavigationbarClicked(Action As String, Va";
 //BA.debugLineNum = 152;BA.debugLine="page.SaveNavigationBarPosition";
_page.SaveNavigationBarPosition();
 //BA.debugLineNum = 153;BA.debugLine="If Action = \"ABMFlexWall\" Then Return";
if ((_action).equals("ABMFlexWall")) { 
if (true) return "";};
 //BA.debugLineNum = 154;BA.debugLine="If Action = \"Contact\" Then";
if ((_action).equals("Contact")) { 
 //BA.debugLineNum = 155;BA.debugLine="myToastId = myToastId + 1";
_mytoastid = (int) (_mytoastid+1);
 //BA.debugLineNum = 156;BA.debugLine="page.ShowToast(\"toast\" & myToastId, \"toastred\",";
...
if (true) return "";
 ...
 //BA.debugLineNum = 159;BA.debugLine="If Action = \"LogOff\" Then";
if ((_action).equals("LogOff")) { 
 //BA.debugLineNum = 160;BA.debugLine="ABMShared.LogOff(page)";
_abmshared._logoff(_page);
 //BA.debugLineNum = 161;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 163;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, Value)";
...
public String  _page_signedoffsocialnetwork(String _network,String _extra) throws Exception{
 //BA.debugLineNum = 166;BA.debugLine="Sub Page_SignedOffSocialNetwork(Network As String,";
 //BA.debugLineNum = 167;BA.debugLine="page.ws.Session.SetAttribute(\"authType\", \"\")";
_page.ws.getSession().SetAttribute("authType",(Object)(""));
 //BA.debugLineNum = 168;BA.debugLine="page.ws.Session.SetAttribute(\"authName\", \"\")";
_page.ws.getSession().SetAttribute("authName",(Object)(""));
 //BA.debugLineNum = 169;BA.debugLine="page.ws.Session.SetAttribute(\"IsAuthorized\", \"\")";
_page.ws.getSession().SetAttribute("IsAuthorized",(Object)(""));
 //BA.debugLineNum = 170;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, \"../\")";
