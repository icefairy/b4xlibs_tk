...
public class comprangepage extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    public static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("abmaterial.ab.com", "abmaterial.ab.com.comprangepage", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", abmaterial.ab.com.comprangepage.class).invoke(this, new Object[] {null});
        else
...
_page.setShowLoaderType(_abm.LOADER_TYPE_MANUAL);
 //BA.debugLineNum = 104;BA.debugLine="page.PageTitle = \"ABMRange\"";
_page.PageTitle = "ABMRange";
 //BA.debugLineNum = 105;BA.debugLine="page.PageDescription = \"The range component \"";
_page.PageDescription = "The range component ";
 //BA.debugLineNum = 106;BA.debugLine="page.PageHTMLName = \"abmaterial-range.html\"";
_page.PageHTMLName = "abmaterial-range.html";
...
_page.UseGoogleAnalytics(_abmshared._trackingid,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(__c.Null)));
 //BA.debugLineNum = 112;BA.debugLine="ABMShared.BuildNavigationBar(page, \"ABMRange\", \".";
_abmshared._buildnavigationbar(_page,"ABMRange","../images/logo.png","","Controls","ABMRange");
...
_abm = new com.ab.abmaterial.ABMaterial();
 //BA.debugLineNum = 11;BA.debugLine="Public Name As String = \"CompRangePage\"";
_name = "CompRangePage";
...
com.ab.abmaterial.ABMRange _range = null;
String _code1 = "";
String _code2 = "";
String _code3 = "";
...
_page.Cell((int) (1),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildparagraph(_page,"par1","Add a range slider for values with two handlers. This one is set to be a number between 0 and 100, a start value of 25 and a stop value of 75.")));
 //BA.debugLineNum = 131;BA.debugLine="page.Cell(1,1).AddComponent(ABMShared.BuildParagr";
_page.Cell((int) (1),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildparagraph(_page,"par2","When using two handles, the minimum distance between the handles can be set using the margin option. The margin value is relative to the value set in 'range'.")));
 //BA.debugLineNum = 133;BA.debugLine="page.Cell(1,1).AddComponent(ABMShared.BuildParagr";
_page.Cell((int) (1),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildparagraph(_page,"par3","The limit option is the oposite of the margin option, limiting the maximum distance between two handles. Used together with the CanChangeWidth=false param, you can 'lock' both handles so changing one changes the other.")));
 //BA.debugLineNum = 135;BA.debugLine="page.Cell(1,1).AddComponent(ABMShared.BuildParagr";
_page.Cell((int) (1),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildparagraph(_page,"par4","For more info on the HandleTooltip, visit {AL}http://refreshless.com/wnumb/{AT}the wNumb page.{/AL}")));
 //BA.debugLineNum = 137;BA.debugLine="Dim range As ABMRange";
_range = new com.ab.abmaterial.ABMRange();
 //BA.debugLineNum = 138;BA.debugLine="range.Initialize(page, \"myrange\", 25, 75, 0, 100,";
_range.Initialize(_page,"myrange",25,75,0,100,1,"");
 //BA.debugLineNum = 139;BA.debugLine="range.HandleToolTip = \"wNumb({ decimals: 0 })\"";
_range.HandleToolTip = "wNumb({ decimals: 0 })";
 //BA.debugLineNum = 140;BA.debugLine="range.Connect = ABM.RANGE_CONNECT_TRUE";
_range.Connect = _abm.RANGE_CONNECT_TRUE;
 //BA.debugLineNum = 142;BA.debugLine="page.Cell(2,1).AddComponent(range)";
_page.Cell((int) (2),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_range));
 //BA.debugLineNum = 145;BA.debugLine="Dim code1 As String = $\"Dim range As ABMRange ran";
_code1 = ("Dim range As ABMRange\n"+"range.Initialize(page, \"myrange\", 25, 75, 0, 100, 1, \"\")\n"+"range.HandleToolTip = \"wNumb({ decimals: 0 })\"\n"+"range.Connect = ABM.RANGE_CONNECT_TRUE\n"+"	\n"+"page.Cell(2,1).AddComponent(range)	");
 //BA.debugLineNum = 152;BA.debugLine="page.Cell(3,1).AddComponent(ABMShared.BuildCodeBl";
_page.Cell((int) (3),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildcodeblockfromsmartstring(_page,"code1",_code1)));
 //BA.debugLineNum = 155;BA.debugLine="page.Cell(4,1).AddComponent(ABMShared.BuildParagr";
_page.Cell((int) (4),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildparagraph(_page,"par5","You can use the comp_changed() event and the GetStart()/SetStart()/GetStop()/SetStop() methods to manipulate the value. Note: for some reason I cannot retrieve the values as double, but only as string.")));
 //BA.debugLineNum = 158;BA.debugLine="Dim code2 As String = $\"Sub myrange_Changed(start";
_code2 = ("Sub myrange_Changed(start As String, stop As String)\n"+"	Log(\"new values: \" & start & \" \" & stop)\n"+"End Sub");
 //BA.debugLineNum = 162;BA.debugLine="Dim code3 As String = $\"Dim range As ABMRange = p";
_code3 = ("Dim range As ABMRange = page.Component(\"myrange\")\n"+"Log(\"current values: \" & range.GetStart & \" \" & range.GetStop)\n"+"range.SetStart(10)\n"+"range.SetStop(90)\n"+"range.Refresh");
...
_page.Cell((int) (5),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildcodeblockfromsmartstring(_page,"code2",_code2+__c.CRLF+__c.CRLF+_code3)));
 //BA.debugLineNum = 172;BA.debugLine="ABMShared.ConnectFooter(page)";
_abmshared._connectfooter(_page);
 //BA.debugLineNum = 174;BA.debugLine="page.Refresh ' IMPORTANT";
_page.Refresh();
 //BA.debugLineNum = 177;BA.debugLine="page.FinishedLoading 'IMPORTANT";
_page.FinishedLoading();
 //BA.debugLineNum = 179;BA.debugLine="page.RestoreNavigationBarPosition";
...
public String  _page_navigationbarclicked(String _action,String _value) throws Exception{
 //BA.debugLineNum = 183;BA.debugLine="Sub Page_NavigationbarClicked(Action As String, Va";
 //BA.debugLineNum = 184;BA.debugLine="page.SaveNavigationBarPosition";
_page.SaveNavigationBarPosition();
 //BA.debugLineNum = 185;BA.debugLine="If Action = \"ABMRange\" Then Return";
if ((_action).equals("ABMRange")) { 
if (true) return "";};
 //BA.debugLineNum = 186;BA.debugLine="If Action = \"Contact\" Then";
if ((_action).equals("Contact")) { 
 //BA.debugLineNum = 187;BA.debugLine="myToastId = myToastId + 1";
_mytoastid = (int) (_mytoastid+1);
 //BA.debugLineNum = 188;BA.debugLine="page.ShowToast(\"toast\" & myToastId, \"toastred\",";
...
if (true) return "";
 ...
 //BA.debugLineNum = 191;BA.debugLine="If Action = \"LogOff\" Then";
if ((_action).equals("LogOff")) { 
 //BA.debugLineNum = 192;BA.debugLine="ABMShared.LogOff(page)";
_abmshared._logoff(_page);
 //BA.debugLineNum = 193;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 195;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, Value)";
...
public String  _page_signedoffsocialnetwork(String _network,String _extra) throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub Page_SignedOffSocialNetwork(Network As String,";
 //BA.debugLineNum = 199;BA.debugLine="page.ws.Session.SetAttribute(\"authType\", \"\")";
_page.ws.getSession().SetAttribute("authType",(Object)(""));
 //BA.debugLineNum = 200;BA.debugLine="page.ws.Session.SetAttribute(\"authName\", \"\")";
_page.ws.getSession().SetAttribute("authName",(Object)(""));
 //BA.debugLineNum = 201;BA.debugLine="page.ws.Session.SetAttribute(\"IsAuthorized\", \"\")";
_page.ws.getSession().SetAttribute("IsAuthorized",(Object)(""));
 //BA.debugLineNum = 202;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, \"../\")";
