...
public class compswitchpage extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    public static java.util.HashMap<String, java.lang.reflect.Method> htSubs;
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new  anywheresoftware.b4a.StandardBA("abmaterial.ab.com", "abmaterial.ab.com.compswitchpage", this);
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba))
                this.getClass().getMethod("_class_globals", abmaterial.ab.com.compswitchpage.class).invoke(this, new Object[] {null});
        else
...
_page.setShowLoaderType(_abm.LOADER_TYPE_MANUAL);
 //BA.debugLineNum = 104;BA.debugLine="page.PageTitle = \"ABMSwitch\"";
_page.PageTitle = "ABMSwitch";
 //BA.debugLineNum = 105;BA.debugLine="page.PageDescription = \"The switch component \"";
_page.PageDescription = "The switch component ";
 //BA.debugLineNum = 106;BA.debugLine="page.PageHTMLName = \"abmaterial-switch.html\"";
_page.PageHTMLName = "abmaterial-switch.html";
...
_page.UseGoogleAnalytics(_abmshared._trackingid,(anywheresoftware.b4a.objects.collections.List) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.collections.List(), (java.util.List)(__c.Null)));
 //BA.debugLineNum = 112;BA.debugLine="ABMShared.BuildNavigationBar(page, \"ABMSwitch\", \"";
_abmshared._buildnavigationbar(_page,"ABMSwitch","../images/logo.png","","Controls","ABMSwitch");
...
_theme.AddABMTheme(_abmshared._mytheme);
 //BA.debugLineNum = 92;BA.debugLine="theme.AddSwitchTheme(\"switchtheme\")";
_theme.AddSwitchTheme("switchtheme");
 //BA.debugLineNum = 93;BA.debugLine="theme.Switch(\"switchtheme\").LabelFontSize = \"1rem";
_theme.Switch("switchtheme").LabelFontSize = "1rem";
...
_abm = new com.ab.abmaterial.ABMaterial();
 //BA.debugLineNum = 11;BA.debugLine="Public Name As String = \"CompSwitchPage\"";
_name = "CompSwitchPage";
...
com.ab.abmaterial.ABMSwitch _switch1 = null;
com.ab.abmaterial.ABMSwitch _switch2 = null;
...
_page.Cell((int) (1),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildparagraph(_page,"par1","Switches are a modern alternative to a checkbox.")));
 //BA.debugLineNum = 131;BA.debugLine="Dim switch1 As ABMSwitch";
_switch1 = new com.ab.abmaterial.ABMSwitch();
 //BA.debugLineNum = 132;BA.debugLine="switch1.Initialize(page, \"switch1\",\"On\", \"Off\", T";
_switch1.Initialize(_page,"switch1","On","Off",__c.True,"switchtheme");
 //BA.debugLineNum = 133;BA.debugLine="page.Cell(2,1).AddComponent(switch1)";
_page.Cell((int) (2),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_switch1));
 //BA.debugLineNum = 135;BA.debugLine="Dim switch2 As ABMSwitch";
_switch2 = new com.ab.abmaterial.ABMSwitch();
 //BA.debugLineNum = 136;BA.debugLine="switch2.Initialize(page, \"switch2\",\"On\", \"Off\", F";
_switch2.Initialize(_page,"switch2","On","Off",__c.False,"switchtheme");
 //BA.debugLineNum = 137;BA.debugLine="switch2.Enabled=False";
_switch2.Enabled = __c.False;
 //BA.debugLineNum = 138;BA.debugLine="page.Cell(3,1).AddComponent(switch2)";
_page.Cell((int) (3),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_switch2));
 //BA.debugLineNum = 141;BA.debugLine="Dim code As StringBuilder";
_code = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 142;BA.debugLine="code.Initialize";
_code.Initialize();
 //BA.debugLineNum = 143;BA.debugLine="code.Append(\"Dim switch1 As ABMSwitch\").Append(CR";
_code.Append("Dim switch1 As ABMSwitch").Append(__c.CRLF);
 //BA.debugLineNum = 144;BA.debugLine="code.Append(\"switch1.Initialize(page, \"\"switch1\"\"";
_code.Append("switch1.Initialize(page, \"switch1\",\"On\", \"Off\", True, \"\")").Append(__c.CRLF);
 //BA.debugLineNum = 145;BA.debugLine="code.Append(\"page.Cell(2,1).AddComponent(switch1)";
_code.Append("page.Cell(2,1).AddComponent(switch1)").Append(__c.CRLF);
 //BA.debugLineNum = 146;BA.debugLine="code.Append(\"\").Append(CRLF)";
_code.Append("").Append(__c.CRLF);
 //BA.debugLineNum = 147;BA.debugLine="code.Append(\"Dim switch2 As ABMSwitch\").Append(CR";
_code.Append("Dim switch2 As ABMSwitch").Append(__c.CRLF);
 //BA.debugLineNum = 148;BA.debugLine="code.Append(\"switch2.Initialize(page, \"\"switch2\"\"";
_code.Append("switch2.Initialize(page, \"switch2\",\"On\", \"Off\", false, \"\")").Append(__c.CRLF);
 //BA.debugLineNum = 149;BA.debugLine="code.Append(\"switch2.Enabled=False\").Append(CRLF)";
_code.Append("switch2.Enabled=False").Append(__c.CRLF);
 //BA.debugLineNum = 150;BA.debugLine="code.Append(\"page.Cell(3,1).AddComponent(switch2)";
_code.Append("page.Cell(3,1).AddComponent(switch2)").Append(__c.CRLF);
...
_page.Cell((int) (4),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildcodeblock(_page,"code",_code)));
 //BA.debugLineNum = 155;BA.debugLine="Dim code2 As StringBuilder";
_code2 = new anywheresoftware.b4a.keywords.StringBuilderWrapper();
 //BA.debugLineNum = 156;BA.debugLine="code2.Initialize";
_code2.Initialize();
 //BA.debugLineNum = 157;BA.debugLine="code2.Append(\"Sub switch1_Clicked(Target as Strin";
_code2.Append("Sub switch1_Clicked(Target as String)").Append(__c.CRLF);
 //BA.debugLineNum = 158;BA.debugLine="code2.Append(\"   Dim checked As String\").Append(C";
_code2.Append("   Dim checked As String").Append(__c.CRLF);
 //BA.debugLineNum = 159;BA.debugLine="code2.Append(\"   Dim switch1 As ABMSwitch = page.";
_code2.Append("   Dim switch1 As ABMSwitch = page.Component(\"switch1\")").Append(__c.CRLF);
 //BA.debugLineNum = 160;BA.debugLine="code2.Append(\"   If switch1.State Then\").Append(C";
_code2.Append("   If switch1.State Then").Append(__c.CRLF);
 //BA.debugLineNum = 161;BA.debugLine="code2.Append(\"      checked= \"\"On\"\"\").Append(CRLF";
_code2.Append("      checked= \"On\"").Append(__c.CRLF);
 //BA.debugLineNum = 162;BA.debugLine="code2.Append(\"   Else\").Append(CRLF)";
_code2.Append("   Else").Append(__c.CRLF);
 //BA.debugLineNum = 163;BA.debugLine="code2.Append(\"      checked= \"\"Off\"\"\").Append(CRL";
_code2.Append("      checked= \"Off\"").Append(__c.CRLF);
 //BA.debugLineNum = 164;BA.debugLine="code2.Append(\"   End If\").Append(CRLF)";
_code2.Append("   End If").Append(__c.CRLF);
 //BA.debugLineNum = 165;BA.debugLine="code2.Append(\"   Dim myTexts, myReturns As List\")";
_code2.Append("   Dim myTexts, myReturns As List").Append(__c.CRLF);
 //BA.debugLineNum = 166;BA.debugLine="code2.Append(\"   myTexts.Initialize\").Append(CRLF";
_code2.Append("   myTexts.Initialize").Append(__c.CRLF);
 //BA.debugLineNum = 167;BA.debugLine="code2.Append(\"   myReturns.Initialize\").Append(CR";
_code2.Append("   myReturns.Initialize").Append(__c.CRLF);
 //BA.debugLineNum = 168;BA.debugLine="code2.Append(\"   myToastId = myToastId + 1\").Appe";
_code2.Append("   myToastId = myToastId + 1").Append(__c.CRLF);
 //BA.debugLineNum = 169;BA.debugLine="code2.Append(\"   page.ShowToast(\"\"toast\"\" & myToa";
_code2.Append("   page.ShowToast(\"toast\" & myToastId, \"toastred\", \"Switch is \" & checked, 5000, myTexts, myReturns)").Append(__c.CRLF);
 //BA.debugLineNum = 170;BA.debugLine="code2.Append(\"End Sub\").Append(CRLF)";
_code2.Append("End Sub").Append(__c.CRLF);
 //BA.debugLineNum = 172;BA.debugLine="page.Cell(5,1).AddComponent(ABMShared.BuildCodeBl";
_page.Cell((int) (5),(int) (1)).AddComponent((com.ab.abmaterial.ABMComponent)(_abmshared._buildcodeblock(_page,"code2",_code2)));
 //BA.debugLineNum = 175;BA.debugLine="ABMShared.ConnectFooter(page)";
_abmshared._connectfooter(_page);
 //BA.debugLineNum = 177;BA.debugLine="page.Refresh ' IMPORTANT";
_page.Refresh();
 //BA.debugLineNum = 180;BA.debugLine="page.FinishedLoading 'IMPORTANT";
_page.FinishedLoading();
 //BA.debugLineNum = 182;BA.debugLine="page.RestoreNavigationBarPosition";
...
public String  _page_navigationbarclicked(String _action,String _value) throws Exception{
 //BA.debugLineNum = 186;BA.debugLine="Sub Page_NavigationbarClicked(Action As String, Va";
 //BA.debugLineNum = 187;BA.debugLine="page.SaveNavigationBarPosition";
_page.SaveNavigationBarPosition();
 //BA.debugLineNum = 188;BA.debugLine="If Action = \"ABMSwitch\" Then Return";
if ((_action).equals("ABMSwitch")) { 
if (true) return "";};
 //BA.debugLineNum = 189;BA.debugLine="If Action = \"Contact\" Then";
if ((_action).equals("Contact")) { 
 //BA.debugLineNum = 190;BA.debugLine="myToastId = myToastId + 1";
_mytoastid = (int) (_mytoastid+1);
 //BA.debugLineNum = 191;BA.debugLine="page.ShowToast(\"toast\" & myToastId, \"toastred\",";
...
if (true) return "";
 ...
 //BA.debugLineNum = 194;BA.debugLine="If Action = \"LogOff\" Then";
if ((_action).equals("LogOff")) { 
 //BA.debugLineNum = 195;BA.debugLine="ABMShared.LogOff(page)";
_abmshared._logoff(_page);
 //BA.debugLineNum = 196;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 198;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, Value)";
...
public String  _page_signedoffsocialnetwork(String _network,String _extra) throws Exception{
 //BA.debugLineNum = 201;BA.debugLine="Sub Page_SignedOffSocialNetwork(Network As String,";
 //BA.debugLineNum = 202;BA.debugLine="page.ws.Session.SetAttribute(\"authType\", \"\")";
_page.ws.getSession().SetAttribute("authType",(Object)(""));
 //BA.debugLineNum = 203;BA.debugLine="page.ws.Session.SetAttribute(\"authName\", \"\")";
_page.ws.getSession().SetAttribute("authName",(Object)(""));
 //BA.debugLineNum = 204;BA.debugLine="page.ws.Session.SetAttribute(\"IsAuthorized\", \"\")";
_page.ws.getSession().SetAttribute("IsAuthorized",(Object)(""));
 //BA.debugLineNum = 205;BA.debugLine="ABMShared.NavigateToPage(ws, ABMPageId, \"../\")";
_abmshared._navigatetopage(_ws,_abmpageid,"../");
 //BA.debugLineNum = 206;BA.debugLine="End Sub";
return "";
}
public String  _switch1_clicked(String _target) throws Exception{
String _checked = "";
com.ab.abmaterial.ABMSwitch _switch1 = null;
 //BA.debugLineNum = 209;BA.debugLine="Sub switch1_Clicked(Target As String)";
 //BA.debugLineNum = 210;BA.debugLine="Dim checked As String";
_checked = "";
 //BA.debugLineNum = 211;BA.debugLine="Dim switch1 As ABMSwitch = page.Component(\"switch";
_switch1 = (com.ab.abmaterial.ABMSwitch)(_page.Component("switch1"));
 //BA.debugLineNum = 212;BA.debugLine="If switch1.State Then";
if (_switch1.getState()) { 
 //BA.debugLineNum = 213;BA.debugLine="checked= \"On\"";
_checked = "On";
 }else {
 //BA.debugLineNum = 215;BA.debugLine="checked= \"Off\"";
_checked = "Off";
 };
 //BA.debugLineNum = 217;BA.debugLine="myToastId = myToastId + 1";
_mytoastid = (int) (_mytoastid+1);
 //BA.debugLineNum = 218;BA.debugLine="page.ShowToast(\"toast\" & myToastId, \"toastred\", \"";
_page.ShowToast("toast"+BA.NumberToString(_mytoastid),"toastred","Switch is "+_checked,(int) (5000));
