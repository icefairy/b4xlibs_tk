...
PDFJS.imageResourcesPath = './images/';
  PDFJS.workerSrc = '../../js/build/pdf.worker.min.js';
...
function webViewerInitialized() {
  ...
  if (document.getElementById('outerContainer').hasAttribute("forcedlang")) {
	var locale = document.getElementById('outerContainer').getAttribute("forcedlang");
  }	
