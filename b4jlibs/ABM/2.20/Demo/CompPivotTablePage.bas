...
page.Cell(2,1).AddComponent(pivot)"$
	...
	page.Cell(4,1).AddComponent(ABMShared.BuildParagraph(page,"par3","Make sure the field names used in the axes and hidden field params are the same!  Here is a snippit of how the CSV in the above Pivot table looks like."))	
