...
page.BuildGrid //IMPORTANT once you loaded the complete grid AND before you start adding components"$
	...
	' add paragraph	
	page.Cell(10,1).AddComponent(ABMShared.BuildParagraph(page, "par13", "{B}AddCellsMP(numberOfCells, marginTopPx, marginBottomPx, paddingLeftPx, paddingRightPx, themeName){/B}"))
	' add param table
	Dim Headers, codes, Descriptions As List
	Headers.Initialize2(Array As String("Param", "Description"))
	...
	' add paragraph
	page.Cell(12,1).AddComponent(ABMShared.BuildParagraph(page, "par17", "Next chapter to read should be the ABMPage object in the Helpers menu."))
