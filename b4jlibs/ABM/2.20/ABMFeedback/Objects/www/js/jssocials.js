...
(function(window, $, jsSocials, undefined) {
    ...
    $.extend(jsSocials.shares, {
		...
		facebookextended: {
            label: "Share",
            logo: "fa fa-facebook",
            shareUrl: "https://www.facebook.com/dialog/feed?app_id={appid}&display=popup&caption={caption}&description={description}&link={url}&redirect_uri={redirecturl}&picture={pictureurl}",
            countUrl: function() {
                return "https://graph.facebook.com/fql?q=SELECT total_count FROM link_stat WHERE url='" + window.encodeURIComponent(this.url) + "'";
            },
            getCount: function(data) {
		...
		facebooklike: {
			label: "Like",
			logo: "fa fa-facebook",
			shareUrl: "https://www.facebook.com/v2.3/plugins/like.php?locale=en_US&share=false&show_faces=false&href={url}",
			countUrl: function() {
				return "https://graph.facebook.com/fql?q=SELECT total_count FROM link_stat WHERE url='" + window.encodeURIComponent(this.url) + "'";
			},
			getCount: function(data) {
