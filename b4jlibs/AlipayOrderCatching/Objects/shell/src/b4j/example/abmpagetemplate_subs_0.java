...
public class abmpagetemplate_subs_0 {


public static RemoteObject  _buildpage(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("BuildPage (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,96);
if (RapidSub.canDelegate("buildpage")) return __ref.runUserSub(false, "abmpagetemplate","buildpage", __ref);
 BA.debugLineNum = 96;BA.debugLine="public Sub BuildPage()";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 98;BA.debugLine="BuildTheme";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.abmpagetemplate.class, "_buildtheme");
 BA.debugLineNum = 101;BA.debugLine="page.InitializeWithTheme(Name, \"/ws/\" & ABMShared";
Debug.ShouldStop(16);
__ref.getField(false,"_page").runVoidMethod ("InitializeWithTheme",(Object)(__ref.getField(true,"_name")),(Object)(RemoteObject.concat(RemoteObject.createImmutable("/ws/"),abmpagetemplate._abmshared._appname,RemoteObject.createImmutable("/"),__ref.getField(true,"_name"))),(Object)(abmpagetemplate.__c.getField(true,"False")),(Object)(abmpagetemplate._abmshared._sessionmaxinactiveintervalseconds),(Object)(__ref.getField(false,"_theme")));
 BA.debugLineNum = 102;BA.debugLine="page.ShowLoader=True";
Debug.ShouldStop(32);
__ref.getField(false,"_page").runMethod(true,"setShowLoader",abmpagetemplate.__c.getField(true,"True"));
 BA.debugLineNum = 103;BA.debugLine="page.PageHTMLName = \"index0.html\"";
Debug.ShouldStop(64);
__ref.getField(false,"_page").setField ("PageHTMLName",BA.ObjectToString("index0.html"));
 BA.debugLineNum = 104;BA.debugLine="page.PageTitle = \"Index\"";
Debug.ShouldStop(128);
__ref.getField(false,"_page").setField ("PageTitle",BA.ObjectToString("Index"));
...
__ref.getField(false,"_page").setField ("PageSiteMapFrequency",__ref.getField(false,"_abm").getField(true,"SITEMAP_FREQ_YEARLY"));
 BA.debugLineNum = 110;BA.debugLine="page.ShowConnectedIndicator = False";
Debug.ShouldStop(8192);
__ref.getField(false,"_page").setField ("ShowConnectedIndicator",abmpagetemplate.__c.getField(true,"False"));
 BA.debugLineNum = 116;BA.debugLine="page.AddRows(2,True, \"\").AddCells12(1,\"\")";
Debug.ShouldStop(524288);
__ref.getField(false,"_page").runMethod(false,"AddRows",(Object)(BA.numberCast(int.class, 2)),(Object)(abmpagetemplate.__c.getField(true,"True")),(Object)(RemoteObject.createImmutable(""))).runVoidMethod ("AddCells12",(Object)(BA.numberCast(int.class, 1)),(Object)(RemoteObject.createImmutable("")));
...
try {
		Debug.PushSubsStack("BuildTheme (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,87);
if (RapidSub.canDelegate("buildtheme")) return __ref.runUserSub(false, "abmpagetemplate","buildtheme", __ref);
...
__ref.getField(false,"_theme").runVoidMethod ("AddABMTheme",(Object)(abmpagetemplate._abmshared._mytheme));
...
abmpagetemplate._ws = RemoteObject.createNew ("anywheresoftware.b4j.object.WebSocket");__ref.setField("_ws",abmpagetemplate._ws);
 //BA.debugLineNum = 5;BA.debugLine="Public page As ABMPage";
abmpagetemplate._page = RemoteObject.createNew ("com.ab.abmaterial.ABMPage");__ref.setField("_page",abmpagetemplate._page);
 //BA.debugLineNum = 7;BA.debugLine="Private theme As ABMTheme";
abmpagetemplate._theme = RemoteObject.createNew ("com.ab.abmaterial.ABMTheme");__ref.setField("_theme",abmpagetemplate._theme);
 //BA.debugLineNum = 9;BA.debugLine="Private ABM As ABMaterial 'ignore";
abmpagetemplate._abm = RemoteObject.createNew ("com.ab.abmaterial.ABMaterial");__ref.setField("_abm",abmpagetemplate._abm);
 //BA.debugLineNum = 11;BA.debugLine="Public Name As String = \"ABMPageTemplate\"  '<----";
abmpagetemplate._name = BA.ObjectToString("ABMPageTemplate");__ref.setField("_name",abmpagetemplate._name);
 //BA.debugLineNum = 13;BA.debugLine="Private ABMPageId As String = \"\"";
abmpagetemplate._abmpageid = BA.ObjectToString("");__ref.setField("_abmpageid",abmpagetemplate._abmpageid);
 //BA.debugLineNum = 16;BA.debugLine="End Sub";
return RemoteObject.createImmutable("");
}
public static RemoteObject  _connectpage(RemoteObject __ref) throws Exception{
try {
		Debug.PushSubsStack("ConnectPage (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,121);
if (RapidSub.canDelegate("connectpage")) return __ref.runUserSub(false, "abmpagetemplate","connectpage", __ref);
...
try {
		Debug.PushSubsStack("Initialize (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,19);
if (RapidSub.canDelegate("initialize")) return __ref.runUserSub(false, "abmpagetemplate","initialize", __ref, _ba);
...
Debug.ShouldStop(1048576);
__ref.runClassMethod (b4j.example.abmpagetemplate.class, "_buildpage");
...
try {
		Debug.PushSubsStack("Page_Authenticated (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,164);
if (RapidSub.canDelegate("page_authenticated")) return __ref.runUserSub(false, "abmpagetemplate","page_authenticated", __ref, _params);
...
try {
		Debug.PushSubsStack("Page_FileUploaded (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,152);
if (RapidSub.canDelegate("page_fileuploaded")) return __ref.runUserSub(false, "abmpagetemplate","page_fileuploaded", __ref, _filename, _success);
...
try {
		Debug.PushSubsStack("Page_FirebaseAuthError (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,168);
if (RapidSub.canDelegate("page_firebaseautherror")) return __ref.runUserSub(false, "abmpagetemplate","page_firebaseautherror", __ref, _extra);
...
try {
		Debug.PushSubsStack("Page_FirebaseAuthStateChanged (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,172);
if (RapidSub.canDelegate("page_firebaseauthstatechanged")) return __ref.runUserSub(false, "abmpagetemplate","page_firebaseauthstatechanged", __ref, _isloggedin);
...
try {
		Debug.PushSubsStack("Page_FirebaseStorageError (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,176);
if (RapidSub.canDelegate("page_firebasestorageerror")) return __ref.runUserSub(false, "abmpagetemplate","page_firebasestorageerror", __ref, _jobid, _extra);
...
try {
		Debug.PushSubsStack("Page_FirebaseStorageResult (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,180);
if (RapidSub.canDelegate("page_firebasestorageresult")) return __ref.runUserSub(false, "abmpagetemplate","page_firebasestorageresult", __ref, _jobid, _extra);
Debug.locals.put("jobID", _jobid);
Debug.locals.put("extra", _extra);
...
try {
		Debug.PushSubsStack("Page_ModalSheetDismissed (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,184);
if (RapidSub.canDelegate("page_modalsheetdismissed")) return __ref.runUserSub(false, "abmpagetemplate","page_modalsheetdismissed", __ref, _modalsheetname);
...
try {
		Debug.PushSubsStack("Page_NavigationbarClicked (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,142);
if (RapidSub.canDelegate("page_navigationbarclicked")) return __ref.runUserSub(false, "abmpagetemplate","page_navigationbarclicked", __ref, _action, _value);
...
Debug.ShouldStop(131072);
abmpagetemplate._abmshared.runVoidMethod ("_logoff",(Object)(__ref.getField(false,"_page")));
...
Debug.ShouldStop(1048576);
abmpagetemplate._abmshared.runVoidMethod ("_navigatetopage",(Object)(__ref.getField(false,"_ws")),(Object)(__ref.getField(true,"_abmpageid")),(Object)(_value));
...
try {
		Debug.PushSubsStack("Page_NextContent (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,188);
if (RapidSub.canDelegate("page_nextcontent")) return __ref.runUserSub(false, "abmpagetemplate","page_nextcontent", __ref, _triggercomponent);
...
try {
		Debug.PushSubsStack("Page_ParseEvent (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,57);
if (RapidSub.canDelegate("page_parseevent")) return __ref.runUserSub(false, "abmpagetemplate","page_parseevent", __ref, _params);
...
_eventparams = abmpagetemplate.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(BA.ObjectToString(",")),(Object)(BA.ObjectToString(_params.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("eventparams")))))));Debug.locals.put("eventParams", _eventparams);Debug.locals.put("eventParams", _eventparams);
...
abmpagetemplate.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("preparing for url refresh")));
 BA.debugLineNum = 62;BA.debugLine="ABM.RemoveMeFromCache(ABMShared.CachedPages, ABM";
Debug.ShouldStop(536870912);
__ref.getField(false,"_abm").runVoidMethod ("RemoveMeFromCache",(Object)(abmpagetemplate._abmshared._cachedpages),(Object)(__ref.getField(true,"_abmpageid")));
...
Debug.ShouldStop(1);
if (abmpagetemplate.__c.runMethod(true,"SubExists",__ref.getField(false, "ba"),(Object)(__ref),(Object)(_eventname)).<Boolean>get().booleanValue()) { 
...
Debug.ShouldStop(32);
abmpagetemplate.__c.runMethodAndSync(false,"CallSubNew",__ref.getField(false, "ba"),(Object)(__ref),(Object)(_eventname));
 break; }
case 1: {
 BA.debugLineNum = 72;BA.debugLine="CallSub2(Me, eventName, Params.Get(eventParams";
Debug.ShouldStop(128);
abmpagetemplate.__c.runMethodAndSync(false,"CallSubNew2",__ref.getField(false, "ba"),(Object)(__ref),(Object)(_eventname),(Object)(_params.runMethod(false,"Get",(Object)((_eventparams.getArrayElement(true,BA.numberCast(int.class, 0)))))));
 break; }
case 2: {
...
Debug.ShouldStop(2048);
abmpagetemplate.__c.runMethodAndSync(false,"CallSubNew2",__ref.getField(false, "ba"),(Object)(__ref),(Object)(_eventname),(Object)((_passedtables)));
 }else {
 BA.debugLineNum = 78;BA.debugLine="CallSub3(Me, eventName, Params.Get(eventParam";
Debug.ShouldStop(8192);
abmpagetemplate.__c.runMethodAndSync(false,"CallSubNew3",__ref.getField(false, "ba"),(Object)(__ref),(Object)(_eventname),(Object)(_params.runMethod(false,"Get",(Object)((_eventparams.getArrayElement(true,BA.numberCast(int.class, 0)))))),(Object)(_params.runMethod(false,"Get",(Object)((_eventparams.getArrayElement(true,BA.numberCast(int.class, 1)))))));
 };
 break; }
default: {
 BA.debugLineNum = 82;BA.debugLine="CallSub2(Me, eventName, Params)";
Debug.ShouldStop(131072);
abmpagetemplate.__c.runMethodAndSync(false,"CallSubNew2",__ref.getField(false, "ba"),(Object)(__ref),(Object)(_eventname),(Object)((_params)));
 break; }
}
;
 };
...
try {
		Debug.PushSubsStack("Page_SignedOffSocialNetwork (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,192);
if (RapidSub.canDelegate("page_signedoffsocialnetwork")) return __ref.runUserSub(false, "abmpagetemplate","page_signedoffsocialnetwork", __ref, _network, _extra);
...
try {
		Debug.PushSubsStack("Page_ToastClicked (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,156);
if (RapidSub.canDelegate("page_toastclicked")) return __ref.runUserSub(false, "abmpagetemplate","page_toastclicked", __ref, _toastid, _action);
...
try {
		Debug.PushSubsStack("Page_ToastDismissed (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,160);
if (RapidSub.canDelegate("page_toastdismissed")) return __ref.runUserSub(false, "abmpagetemplate","page_toastdismissed", __ref, _toastid);
Debug.locals.put("ToastId", _toastid);
...
try {
		Debug.PushSubsStack("WebSocket_Connected (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,24);
if (RapidSub.canDelegate("websocket_connected")) return __ref.runUserSub(false, "abmpagetemplate","websocket_connected", __ref, _websocket1);
...
Debug.ShouldStop(16777216);
abmpagetemplate.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("Connected")));
...
_session = __ref.getField(false,"_abm").runMethod(false,"GetSession",(Object)(__ref.getField(false,"_ws")),(Object)(abmpagetemplate._abmshared._sessionmaxinactiveintervalseconds));Debug.locals.put("session", _session);Debug.locals.put("session", _session);
 BA.debugLineNum = 30;BA.debugLine="If ABMShared.NeedsAuthorization Then";
Debug.ShouldStop(536870912);
if (abmpagetemplate._abmshared._needsauthorization.<Boolean>get().booleanValue()) { 
...
Debug.ShouldStop(-2147483648);
abmpagetemplate._abmshared.runVoidMethod ("_navigatetopage",(Object)(__ref.getField(false,"_ws")),(Object)(__ref.getField(true,"_abmpageid")),(Object)(RemoteObject.createImmutable("../")));
...
Debug.ShouldStop(16);
__ref.getField(false,"_abm").runVoidMethod ("UpdateFromCache",(Object)((__ref)),(Object)(abmpagetemplate._abmshared._cachedpages),(Object)(__ref.getField(true,"_abmpageid")),(Object)(__ref.getField(false,"_ws")),__ref.getField(false, "ba"));
...
__ref.runClassMethod (b4j.example.abmpagetemplate.class, "_connectpage");
 };
 BA.debugLineNum = 49;BA.debugLine="Log(ABMPageId)";
Debug.ShouldStop(65536);
abmpagetemplate.__c.runVoidMethod ("Log",(Object)(__ref.getField(true,"_abmpageid")));
...
try {
		Debug.PushSubsStack("WebSocket_Disconnected (abmpagetemplate) ","abmpagetemplate",3,__ref.getField(false, "ba"),__ref,53);
if (RapidSub.canDelegate("websocket_disconnected")) return __ref.runUserSub(false, "abmpagetemplate","websocket_disconnected", __ref);
 BA.debugLineNum = 53;BA.debugLine="Private Sub WebSocket_Disconnected";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 54;BA.debugLine="Log(\"Disconnected\")";
Debug.ShouldStop(2097152);
abmpagetemplate.__c.runVoidMethod ("Log",(Object)(RemoteObject.createImmutable("Disconnected")));
